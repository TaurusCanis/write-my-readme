      ...
      <div className="relative overflow-hidden">
        ...
        <header className="relative pt-6 pb-16 sm:pb-24">
          ...
          <div className="flex justify-center mt-6">
            <div className="flex flex-col items-center">
              <Link to="/form" className="px-4 py-2 font-medium text-xl bg-emerald-500 text-white rounded-lg w-[250px] h-[54px] flex items-center justify-center">
                Try It Now
              </Link>
            </div>
          </div>
        ...
        <section className="py-16">
          <div className="px-4 mx-auto text-center max-w-7xl sm:px-6">
            ...
            <div className="mt-10">
              <Link to="/form" className="bg-emerald-500 text-white py-2 px-4 rounded-lg text-xl">
                  Get Started
              </Link>
            </div>
          </div>
